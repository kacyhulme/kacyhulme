...
class Overlay extends React.Component {
  render() {
    return (
      ...
      <div><InnerDiv info="words"/></div>
      <div><InnerDiv info="some"/></div>
      <div><InnerDiv info="times"/></div>
      <div><InnerDiv info="there"/></div>
      <div><InnerDiv info="are"/></div>
      <div><InnerDiv info="words"/></div>
      <div><InnerDiv info="and"/></div>
      <div><InnerDiv info="some"/></div>
      <div><InnerDiv info="times"/></div>
      <div><InnerDiv info="there"/></div>
      <div><InnerDiv info="are"/></div>
      <div><InnerDiv info="not"/></div>
      <div><InnerDiv info="words"/></div>
      <div><InnerDiv info="for"/></div>
      <div><InnerDiv info="the"/></div>
      <div><InnerDiv info="things"/></div>
      <div><InnerDiv info="we"/></div>
      <div><InnerDiv info="want"/></div>
      <div><InnerDiv info="to"/></div>
      <div><InnerDiv info="say"/></div>
      <div><InnerDiv info="words"/></div>
      <div><InnerDiv info="some"/></div>
      <div><InnerDiv info="times"/></div>
      <div><InnerDiv info="there"/></div>
...
class InnerDiv extends React.Component {
  render() {
    return (
      <div className="innerdiv"> {this.props.info}</div>
      )
  }
}